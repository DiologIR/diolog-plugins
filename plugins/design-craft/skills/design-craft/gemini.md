...
- **§10 accessibility — the largest single gap.** Measured in the artifact:
...
- **§14 system thinking — measurable, so measure it.** The artifact declared 11 CSS
  custom properties and used **45 raw hex literals** alongside them. The comparison
