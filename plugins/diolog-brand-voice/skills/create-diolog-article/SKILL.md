...
description: "Write a long-form article or blog post in Diolog's brand voice — an Australian investor-communication SaaS ('the workspace for everything investor-facing', tagline 'Disclosure, without doubt.'). Produces a ready-to-publish, cited, compliance-aware article that sounds like Diolog: precise, warm, plainly authoritative, no em or en dashes, no AI clichés, Australian English. Handles every article register — investor-education (retail/beginner), IR best practice (IR pros, boards, company secretaries), thought leadership, and announcements. Use this skill whenever the user wants to draft, write, ghostwrite, create, or generate a Diolog blog post, article, thought-leadership piece, or investor-education explainer (or says 'write a Diolog article/blog post on X', 'turn this research into a Diolog article', 'draft a thought-leadership piece for the Diolog blog', 'write us a piece explaining X to investors'), especially anything about investor relations, disclosure, ASX/ASIC compliance, AGMs, dividends, retail investing, or the Diolog product. Trigger even if they don't say the word 'voice' — a Diolog-destined blog/article request qualifies. This is the BRAND voice, not a personal one; for a post in Luke Rhodes' personal voice use create-luke-article, and for LinkedIn/social brand posts see the deployed diolog-linkedin-writer prompt."
allowed-tools:
  - "Read"
  - "Write"
  - "Bash"
...
This skill is the fuller, blog/article counterpart to the deployed generation prompts in the main Diolog repo (`apps/website/personas/diolog-content-writer-system-prompt.md`), and stays consistent with them. LinkedIn/social brand posts are covered by the deployed `diolog-linkedin-writer` prompt; posts in Luke's personal voice by the `create-luke-article` skill.
