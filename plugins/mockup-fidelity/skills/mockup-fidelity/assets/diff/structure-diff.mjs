...
L.push(`- matched: ${pairs.size}  ·  **layout mismatches: ${layoutFails.length}**  ·  **missing (in mock, absent in app): ${missing.length}**  ·  **extra (app-only): ${extra.length}**  ·  child-count diffs: ${childCountFails.length}`);
L.push('');
