...
- **Bundled redacted corpus** (`references/research/`) — her actual emails, LinkedIn quotes, Slack messages, and interview excerpts (client names, PII and third-party companies redacted). Style ground truth, never fact sources.
